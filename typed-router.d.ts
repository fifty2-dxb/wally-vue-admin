...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'pages-advertisement-materials': RouteRecordInfo<'pages-advertisement-materials', '/pages/advertisement/materials', Record<never, never>, Record<never, never>>,
    ...
    'pages-campaigns': RouteRecordInfo<'pages-campaigns', '/pages/campaigns', Record<never, never>, Record<never, never>>,
    ...
    'pages-campaigns-topup-failed-payment-card': RouteRecordInfo<'pages-campaigns-topup-failed-payment-card', '/pages/campaigns/topup/FailedPaymentCard', Record<never, never>, Record<never, never>>,
    'pages-campaigns-topup-payment-card': RouteRecordInfo<'pages-campaigns-topup-payment-card', '/pages/campaigns/topup/PaymentCard', Record<never, never>, Record<never, never>>,
    'pages-campaigns-topup-thank-you-payment-card': RouteRecordInfo<'pages-campaigns-topup-thank-you-payment-card', '/pages/campaigns/topup/ThankYouPaymentCard', Record<never, never>, Record<never, never>>,
    ...
    'pages-certificates': RouteRecordInfo<'pages-certificates', '/pages/certificates', Record<never, never>, Record<never, never>>,
    'pages-certificates-apple-certificates-how-it-works-dialog': RouteRecordInfo<'pages-certificates-apple-certificates-how-it-works-dialog', '/pages/certificates/AppleCertificatesHowItWorksDialog', Record<never, never>, Record<never, never>>,
    'pages-certificates-apple-certificates-table': RouteRecordInfo<'pages-certificates-apple-certificates-table', '/pages/certificates/AppleCertificatesTable', Record<never, never>, Record<never, never>>,
    'pages-certificates-card-add-apple-certificates-key-dialog': RouteRecordInfo<'pages-certificates-card-add-apple-certificates-key-dialog', '/pages/certificates/CardAddAppleCertificatesKeyDialog', Record<never, never>, Record<never, never>>,
    'pages-certificates-card-add-google-certificates-key-dialog': RouteRecordInfo<'pages-certificates-card-add-google-certificates-key-dialog', '/pages/certificates/CardAddGoogleCertificatesKeyDialog', Record<never, never>, Record<never, never>>,
    'pages-certificates-google-certificates-how-it-works-dialog': RouteRecordInfo<'pages-certificates-google-certificates-how-it-works-dialog', '/pages/certificates/GoogleCertificatesHowItWorksDialog', Record<never, never>, Record<never, never>>,
    ...
    'pages-marketing-apple-apple-phone-preview': RouteRecordInfo<'pages-marketing-apple-apple-phone-preview', '/pages/marketing/apple/ApplePhonePreview', Record<never, never>, Record<never, never>>,
    'pages-marketing-apple-apple-table': RouteRecordInfo<'pages-marketing-apple-apple-table', '/pages/marketing/apple/AppleTable', Record<never, never>, Record<never, never>>,
    'pages-marketing-email': RouteRecordInfo<'pages-marketing-email', '/pages/marketing/email', Record<never, never>, Record<never, never>>,
    'pages-marketing-google': RouteRecordInfo<'pages-marketing-google', '/pages/marketing/google', Record<never, never>, Record<never, never>>,
    'pages-marketing-google-google-phone-preview': RouteRecordInfo<'pages-marketing-google-google-phone-preview', '/pages/marketing/google/GooglePhonePreview', Record<never, never>, Record<never, never>>,
    'pages-marketing-google-google-table': RouteRecordInfo<'pages-marketing-google-google-table', '/pages/marketing/google/GoogleTable', Record<never, never>, Record<never, never>>,
    'pages-marketing-sms': RouteRecordInfo<'pages-marketing-sms', '/pages/marketing/sms', Record<never, never>, Record<never, never>>,
    ...
    'pages-nfc-keys': RouteRecordInfo<'pages-nfc-keys', '/pages/nfc-keys', Record<never, never>, Record<never, never>>,
    'pages-nfc-keys-apple-nfchow-it-works': RouteRecordInfo<'pages-nfc-keys-apple-nfchow-it-works', '/pages/nfc-keys/AppleNFCHowItWorks', Record<never, never>, Record<never, never>>,
    'pages-nfc-keys-apple-nfctable': RouteRecordInfo<'pages-nfc-keys-apple-nfctable', '/pages/nfc-keys/AppleNFCTable', Record<never, never>, Record<never, never>>,
    'pages-nfc-keys-card-apple-add-nfcdialog': RouteRecordInfo<'pages-nfc-keys-card-apple-add-nfcdialog', '/pages/nfc-keys/CardAppleAddNFCDialog', Record<never, never>, Record<never, never>>,
    'pages-nfc-keys-google-nfchow-it-works-dialog': RouteRecordInfo<'pages-nfc-keys-google-nfchow-it-works-dialog', '/pages/nfc-keys/GoogleNFCHowItWorksDialog', Record<never, never>, Record<never, never>>,
