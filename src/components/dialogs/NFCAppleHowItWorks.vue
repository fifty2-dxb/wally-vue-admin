...
const props = defineProps({
  cert: Object, // To receive the current certificate details
  open: Boolean // Prop to control the dialog visibility
});
...
// Watch for changes in the `open` prop and update `dialogVisible` accordingly
