<template>
    <div class="w-100 pb-3">
        <div class="d-flex align-center justify-center flex-column">
            <v-btn-toggle class="my-3" v-model="selectedPlatform" divided variant="outlined" color="primary"
                v-if="!seeAll">
                                    ...
                                    <div class="apple-side-btn-container">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center cursor-link"
                                            ...
                                            <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                                class="dynamic-icon" style="width: 14px; height: 14px;">
                                                <path
                                    ...
                                    <div class="apple-card-container" id="applePreview"
                                        ...
                                        <div class="apple-fields">
                                            <div class="container-value"
                                                v-if="data.template.fields?.apple.f3 != 'empty'">
                                            ...
                                            <div class="container-value"
                                                v-if="data.template.fields?.apple?.f4 != 'empty'">
                                            ...
                                            <div class="container-value"
                                                v-if="data.template.fields?.apple.f5 != 'empty'">
                    ...
                    <div class="google-container">
                        <v-img src="/images/loyalty/googleLayout.svg" alt="" :width="seeAll ? '300px' : '300px'">
                            <div class="google-screen-container">
                                    ...
                                    :style="{ background: data.template.properties?.background, color: data.template.properties?.text }">
                                        <div data-v-e0338a20=""
                                            class="GoogleCardContainer--header d-flex align-items-center"
                                            bis_skin_checked="1">
                                        ...
                                        <div class="GoogleCardContainer--barcode"
                                            bis_skin_checked="1">
                                            <div class="barcode-container code128"
                                                bis_skin_checked="1"><img data-v-e0338a20=""
...
.google-container .GoogleCardContainer--barcode {
    height: 140px;
...
.google-container .GoogleCardContainer--barcode .barcode-container.code128 {
    padding: 5px;
    width: 190px;
    height: 70px;
}
.google-container .GoogleCardContainer--barcode .barcode-container {
    background: #fff;
    border-radius: 2px;
}

.google-container .img-fluid, .img-thumbnail {
    max-width: 100%;
    height: auto;
}

.google-container .GoogleCardContainer--barcode .barcode-name {
    margin-top: 10px;
    font-size: 13px;
    font-weight: 400;
    overflow: hidden;
