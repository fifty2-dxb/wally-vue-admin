...
<template>
  <VDialog v-model="dialogVisible" :width="$vuetify.display.smAndDown ? 'auto' : 600">
    ...
    <VCard>
      ...
      <VCardText>
        With <span class="btn btn-sm btn-primary px-2">new Apple VAS NFC Key</span>, you can either generate a
        new key pair and store the private key in the NFC reader or upload a public key provided by your NFC reader's
        manufacturer.
      </VCardText>

      <VCardText>
        Activate NFC in "Pass Settings / NFC" and select the NFC key for your pass there.
      </VCardText>
      <VDivider class="my-1" />
